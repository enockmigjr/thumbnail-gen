      ...
      <div className="relative z-10 w-full max-w-3xl bg-white dark:bg-[#0f0f0f] rounded-3xl shadow-2xl border border-neutral-200 dark:border-white/10 overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-8 py-5 border-b border-neutral-100 dark:border-white/5 shrink-0">
          <div className="flex items-center gap-3">
             ...
             <div>
               <h2 className="text-2xl font-black uppercase tracking-tight dark:text-white">Titres Optimisés CTR</h2>
               <p className="text-sm text-neutral-500 font-bold uppercase tracking-widest italic">Analyse sémantique IA</p>
             </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-8 pt-6 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
             <div className="space-y-4">
                <h3 className="text-sm font-black uppercase tracking-widest text-emerald-500">Aperçu Visuel</h3>
                ...
                <div className="flex gap-2 p-3 rounded-xl bg-emerald-50 dark:bg-emerald-950/20 text-emerald-600 dark:text-emerald-400">
                   ...
                   <p className="text-xs font-medium leading-relaxed">Ces titres ont été générés en analysant les éléments visuels et cognitifs de votre miniature.</p>
                </div>
             </div>

             <div className="space-y-4">
                <h3 className="text-sm font-black uppercase tracking-widest text-neutral-400">Suggestions (Top 5)</h3>
        ...
        <div className="px-8 py-4 border-t border-neutral-100 dark:border-white/5 bg-neutral-50 dark:bg-neutral-950/50 flex justify-end shrink-0">
           <Button onClick={onClose} variant="secondary" className="rounded-xl font-bold uppercase tracking-widest text-xs h-10 px-6">
             Fermer
           </Button>
        </div>
      </div>
